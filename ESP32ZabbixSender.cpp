...
int ESP32ZabbixSender::Send(void)
{ // Send items
...
void ESP32ZabbixSender::ClearItem(void)
{ // Clear item list
	zabbixItemSize = 0;
}
...
{
	zabbixItemSize = 4;
	zabbixItemList[0].key = "usage";
	zabbixItemList[0].val = percentUsed;
